...
import { Car, LogOut, Settings, Menu, Phone, Mail, AtSign, Facebook, Instagram, MessageCircle, Music, Video } from 'lucide-react';
          ...
          <nav className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              {socialMedia.tiktok && (
                ...
                >
                  <Video className="h-4 w-4" style={{ color: '#000000' }} />
                </Button>
              )}
